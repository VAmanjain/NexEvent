...
//         setFormData({ ...formData, userProfileId: profile?.id })
...
//     setFormData({ ...formData, [dateType]: formattedDateTime });
//   };

//   const handleValueChange = (name: keyof EventsDto) => (value: string) => {
//     setFormData({ ...formData, [name]: value });
//   };

//   const handleSwitchChange = (checked: boolean) => {
//     setFormData({ ...formData, approval: checked });
//   };

//   const handleSubmit = async (e: React.FormEvent) => {
//     e.preventDefault();
//     try {
//       formData.userProfileId = userProfileData?.id;
//      const response:EventsDto =  await createEvent(formData);
//       console.log("Event created successfully:", response);
//       if(response){
//         navigator(  `/event/${response.id}`, {replace:true})
//       }
//     } catch (error) {
...
//     className="flex flex-col md:flex-row gap-6 p-6  mx-auto max-w-[1000px] text-white"
//   >
...
//           className="absolute bottom-2 left-2 bg-white rounded-full p-2 cursor-pointer"
//         >
...
//         {/* <Select>
//           <SelectTrigger className="w-[200px] cursor-pointer bg-white/10 rounded-[8px] shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-[5px] border border-white/10 p-2 placeholder:font-medium placeholder:text-white placeholder:text-sm focus-visible:ring-0">
//             <SelectValue placeholder={formData.cal_name} />
//           </SelectTrigger>
//           <SelectContent>
//             <SelectItem value="public">Personal Calendar</SelectItem>
//             <SelectItem value="private">Create calendar</SelectItem>
//           </SelectContent>
//         </Select> */}
//         {/* <Select
//           value={formData.type}
...
//         >
//           <SelectTrigger className="w-[120px] cursor-pointer bg-white/10 rounded-[8px] shadow-[0_4px_30px_rgba(0,0,0,0.1)] backdrop-blur-[5px] border border-white/10 p-2 placeholder:font-medium placeholder:text-white placeholder:text-sm focus-visible:ring-0">
//             <SelectValue />
//           </SelectTrigger>
//           <SelectContent>
...
//                 handleDateTimeChange(
//                   "startingTime",
//                   `${formData.startingTime.split("T")[0] || "2024-01-01"}T${
//                     e.target.value
//                   }`
//                 )
//               }
...
//                 handleDateTimeChange(
//                   "endingTime",
//                   `${formData.endingTime.split("T")[0] || "2024-01-01"}T${
//                     e.target.value
//                   }`
//                 )
//               }
...
//             type="number"
//             name="limit"
//             defaultValue={formData.limit !== null ? formData.limit : 0} // Use 0 or any default number
//             onChange={handleChange}
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        setFormData(prev => ({
          ...prev,
          startingTime: `${startDate}T${startTime}`,
          endingTime: `${endDate}T${endTime}`
        }));
